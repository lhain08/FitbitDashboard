...
class TestDataManager:
    ...
    def test_get_steps_success(self):
        ...
        assert self.data_manager_under_test.get_steps_data(
            "2022-04-01", "2022-04-04"
        ) == {
            "Time": ["2022-04-01", "2022-04-02", "2022-04-03"],
            "Steps": [1000, 2000, 3000],
        }
        assert self.mock_client.time_series.called_with(
            "activities/steps", base_date="2022-04-01", end_date="2022-04-04"
        )
    ...
    def test_get_distance(self):
        ...
        assert self.data_manager_under_test.get_distance_data(
            "2022-04-01", "2022-04-04"
        ) == {
            "Time": ["2022-04-01", "2022-04-02", "2022-04-03"],
        ...
        assert self.mock_client.time_series.called_with(
            "activities/distance", base_date="2022-04-01", end_date="2022-04-04"
        )
    ...
    def test_get_calories_success(self):
        ...
        assert self.data_manager_under_test.get_calories_data(
            "2022-04-01", "2022-04-04"
        ) == {
            "Time": ["2022-04-01", "2022-04-02", "2022-04-03"],
        ...
        assert self.mock_client.time_series.called_with(
            "activities/calories", base_date="2022-04-01", end_date="2022-04-04"
        )
    ...
    def test_get_elevation_success(self):
        ...
        assert self.data_manager_under_test.get_elevation_data(
            "2022-04-01", "2022-04-04"
        ) == {
            "Time": ["2022-04-01", "2022-04-02", "2022-04-03"],
        ...
        assert self.mock_client.time_series.called_with(
            "activities/elevation", base_date="2022-04-01", end_date="2022-04-04"
        )
    ...
    def test_get_floors_success(self):
        ...
        assert self.data_manager_under_test.get_floors_data(
            "2022-04-01", "2022-04-04"
        ) == {
            "Time": ["2022-04-01", "2022-04-02", "2022-04-03"],
        ...
        assert self.mock_client.time_series.called_with(
            "activities/floors", base_date="2022-04-01", end_date="2022-04-04"
        )
    ...
    def test_get_steps_intraday_success(self):
        ...
        assert self.mock_client.time_series.called_with(
            "activities/steps", base_date="2022-04-01", detail_level="15min"
        )
    ...
    def test_get_distance_intraday_success(self):
        ...
        assert self.mock_client.time_series.called_with(
            "activities/distance", base_date="2022-04-01", detail_level="15min"
        )
    ...
    def test_get_calories_intraday_success(self):
        ...
        assert self.data_manager_under_test.get_calories_data(
            "2022-04-01", "15min"
        ) == {"Time": ["01:00:00", "01:15:00", "01:30:00"], "Calories": [111, 222, 333]}
        assert self.mock_client.time_series.called_with(
            "activities/calories", base_date="2022-04-01", detail_level="15min"
        )
    ...
    def test_get_elevation_intraday_success(self):
        ...
        assert self.mock_client.time_series.called_with(
            "activities/elevation", base_date="2022-04-01", detail_level="15min"
        )
    ...
    def test_get_floors_intraday_success(self):
        ...
        assert self.mock_client.time_series.called_with(
            "activities/floors", base_date="2022-04-01", detail_level="15min"
        )
